        ...
        saveBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(secondNameText == null || "".equals(secondNameText)){
                    JOptionPane.showMessageDialog(contentPane, "Please enter First name", "System prompt", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                if(phoneNumber == null || "".equals(phoneNumber) || phoneNumber.length() != 11 ){
                    JOptionPane.showMessageDialog(contentPane, "Wrong mobile phone number", "System prompt", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                // int i = 0;
                try{
                ...
                try{
                    ...
                    e1.printStackTrace();
                    JOptionPane.showMessageDialog(contentPane, "Incorrect postcode", "System prompt", JOptionPane.WARNING_MESSAGE);
                ...
                boolean flag = memberDao.update(member1);
                if(flag){
                    dispose();
                    JOptionPane.showMessageDialog(contentPane, "Modified successfully, refresh can view!");
                }else{
